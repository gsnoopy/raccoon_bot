...
async function deleteBicho(interaction) {
    ...
    try {
        ...
        const buttonIndex = row.components.findIndex(component => component.customId === 'deleteBicho');
        if (buttonIndex !== -1) {
        ...
        console.error('Erro ao processar botão "deleteBicho":', error);
        await interaction.reply({ content: "Erro ao processar o botão deleteBicho.", ephemeral: true });
    }
}

module.exports = { deleteBicho };
