...
async function deleteRandom(interaction) {
    ...
    try {
        ...
        const buttonIndex = row.components.findIndex(component => component.customId === 'deleteRandom');
        if (buttonIndex !== -1) {
        ...
        console.error('Erro ao processar botão "deleteRandom":', error);
        await interaction.reply({ content: "Erro ao processar o botão deleteRandom.", ephemeral: true });
    }
}

module.exports = { deleteRandom };
