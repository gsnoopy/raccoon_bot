...
async function deleteUp(interaction) {
    ...
    try {
        ...
        console.error('Erro ao processar botão "deleteUp":', error);
        await interaction.reply({ content: "Erro ao processar o botão deleteUp.", ephemeral: true });
    }
}

module.exports = { deleteUp };
