...
async function submitSkin(interaction, price) {

  await interaction.deferReply({ephemeral: true})

  try {

      const skinName = interaction.fields.getTextInputValue('skinInput')
      ...
      const description = `Smurf Skin - ${interaction.user.username}`;
