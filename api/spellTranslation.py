...
def main():
    en_url = "https://ddragon.leagueoflegends.com/cdn/14.5.1/data/en_US/summoner.json"
    pt_url = "https://ddragon.leagueoflegends.com/cdn/14.5.1/data/pt_BR/summoner.json"
    ...
    if en_json and pt_json:
        ...
        print("Merged translations saved to 'spells.json'")
